...
class L2ToL1Message {
    ...
    static async getL2ToL1MessageLogs(l2Provider, filter, batchNumber, destination, uniqueId, indexInBatch) {
        ...
        const events = (await eventFetcher.getEvents(constants_1.ARB_SYS_ADDRESS, ArbSys__factory_1.ArbSys__factory, t => t.filters.L2ToL1Transaction(null, destination, uniqueId, batchNumber), filter)).map(l => (Object.assign(Object.assign({}, l.event), { transactionHash: l.transactionHash })));
        if (indexInBatch) {
