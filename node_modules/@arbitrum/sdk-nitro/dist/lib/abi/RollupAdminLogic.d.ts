...
export interface RollupAdminLogicInterface extends utils.Interface {
    ...
    functions: {
        ...
        "initialize((uint64,uint64,address,uint256,bytes32,address,address,uint256,(uint256,uint256,uint256,uint256)),(address,address,address,address,address,address,address,address,address,address))": FunctionFragment;
