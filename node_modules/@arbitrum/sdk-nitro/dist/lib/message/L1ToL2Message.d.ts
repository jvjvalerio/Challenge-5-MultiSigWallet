...
export declare abstract class L1ToL2Message {
    ...
    static fromTxComponents<T extends SignerOrProvider>(l2SignerOrProvider: T, chainId: number, sender: string, messageNumber: BigNumber, l1BaseFee: BigNumber, messageData: RetryableMessageParams, retryableCreationId?: string): L1ToL2MessageReaderOrWriter<T>;
    protected constructor(chainId: number, sender: string, messageNumber: BigNumber, l1BaseFee: BigNumber, messageData: RetryableMessageParams, retryableCreationId?: string);
}
/**
