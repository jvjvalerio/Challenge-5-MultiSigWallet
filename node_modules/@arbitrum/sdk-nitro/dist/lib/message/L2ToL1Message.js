...
class L2ToL1Message {
    ...
    static async getL2ToL1Events(l2Provider, filter, position, destination, hash) {
        ...
        return (await eventFetcher.getEvents(constants_1.ARB_SYS_ADDRESS, ArbSys__factory_1.ArbSys__factory, t => t.filters.L2ToL1Tx(null, destination, hash, position), filter)).map(l => (Object.assign(Object.assign({}, l.event), { transactionHash: l.transactionHash })));
    }
}
...
class L2ToL1MessageReader extends L2ToL1Message {
    ...
    async getBlockFromNodeNum(rollup, nodeNum, l2Provider) {
        ...
        if (logs.length !== 1)
            throw new errors_1.ArbSdkError('No NodeCreated events found');
