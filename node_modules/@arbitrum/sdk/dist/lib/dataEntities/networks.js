...
const getL1Network = async (signerOrProvider, l2ChainId) => {
    const network = await ((await (0, migration_types_1.isNitroL1)(l2ChainId, signerOrProvider))
        ? nitro
        : classic).getL1Network(signerOrProvider);
    return (0, lib_1.isDefined)(network.rpcURL)
        ? network
        : Object.assign(Object.assign({}, network), { rpcURL: process.env['L1RPC'] || 'undefined rpc' });
};
