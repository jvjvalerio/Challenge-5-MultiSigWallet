...
export declare abstract class L1ToL2Message {
    static fromClassic<T extends SignerOrProvider>(readerOrWriter: ClassicL1ToL2MessageReaderOrWriter<T>): L1ToL2MessageWriter | L1ToL2MessageReader;
    static fromNitro<T extends SignerOrProvider>(readerOrWriter: NitroL1ToL2MessageReaderOrWriter<T>): L1ToL2MessageReader | L1ToL2MessageWriter;
...
export declare class L1ToL2MessageReader extends L1ToL2Message implements IL1ToL2MessageReader {
    ...
    static fromClassic(classicReader: classic.L1ToL2MessageReader): L1ToL2MessageReader;
    static fromNitro(nitroReader: nitro.L1ToL2MessageReader): L1ToL2MessageReader;
    private readonly classicReader?;
    private readonly classicPartnerReader?;
...
export declare class L1ToL2MessageWriter extends L1ToL2MessageReader implements IL1ToL2MessageWriter {
    ...
    private readonly classicPartnerWriter?;
    static fromClassic(classicWriter: classic.L1ToL2MessageWriter): L1ToL2MessageWriter;
    static fromNitro(nitroWriter: nitro.L1ToL2MessageWriter): L1ToL2MessageWriter;
