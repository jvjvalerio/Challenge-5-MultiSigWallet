...
let BaseSystemDictator;
try {
    BaseSystemDictator = require('../artifacts/contracts/deployment/BaseSystemDictator.sol/BaseSystemDictator.json');
}
catch (_a) { }
let DeployConfig;
try {
    DeployConfig = require('../artifacts/contracts/deployment/DeployConfig.sol/DeployConfig.json');
}
catch (_b) { }
let FreshSystemDictator;
try {
    FreshSystemDictator = require('../artifacts/contracts/deployment/FreshSystemDictator.sol/FreshSystemDictator.json');
}
catch (_c) { }
let MigrationSystemDictator;
try {
    MigrationSystemDictator = require('../artifacts/contracts/deployment/MigrationSystemDictator.sol/MigrationSystemDictator.json');
}
catch (_d) { }
let PortalSender;
try {
