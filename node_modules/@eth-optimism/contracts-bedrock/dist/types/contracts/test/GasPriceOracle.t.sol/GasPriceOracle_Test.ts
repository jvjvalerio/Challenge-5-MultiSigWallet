...
export interface GasPriceOracle_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_overhead()": FunctionFragment;
    "test_owner()": FunctionFragment;
    "test_scalar()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_overhead",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GasPriceOracle_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_overhead(overrides?: CallOverrides): Promise<void>;

    test_owner(overrides?: CallOverrides): Promise<void>;

    test_scalar(overrides?: CallOverrides): Promise<void>;
